...
tokenizer = AutoTokenizer.from_pretrained("Pavan48/bart-base-cnn-dailymail-highlights-128")
model = AutoModelForSeq2SeqLM.from_pretrained("Pavan48/bart-base-cnn-dailymail-highlights-128")
