...
def home():
    fetch_news()
    return render_template('home.html', news_data=cached_news)
...
def search():
    ...
    if query:
        ...
        return render_template('home.html', news_data=search_results)
...
def summarize_article():
    summary = summarize(request.form['text'], request.files)
...
def ask():
    answer = ask_question(request.form['text'], request.form['question'], request.files)
...
# def detect():
#     detection_result = detect_fake_news(request.form['text'], request.files)
#     return render_template('fake_news_detection.html', detection_result=detection_result)
